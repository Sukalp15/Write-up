  ...
  for(int i=1;i<=id3;i++){
    ...
    if(ai!=null)
    {
      id2=i;//ProductSelected
            ...
            Data dt = new Data();
            dt.seti(id3);
            request.getSession().setAttribute("total_exam",dt);
            request.getSession().setAttribute("chosen_exam_id",dt1);
           ...
           dbconn = new DatabaseConnection();
            ...
            try {
                if (res.next())
                {
                    ...
                    exdetail.setid(id2);
                    exdetail.setName(res.getString("name"));
                    exdetail.setSub1(res.getString("subject1"));
                    exdetail.setSub2(res.getString("subject2"));
                    exdetail.setSub3(res.getString("subject3"));
                    exdetail.setDept(res.getString("department"));
