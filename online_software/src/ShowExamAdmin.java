...
public class ShowExamAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher rd = req.getRequestDispatcher("examDisplayadmin.jsp");/*SEE*/
        rd.forward(req,resp);
    ...
    private ArrayList<ExamDetail> getResult(ResultSet rs) throws SQLException {
        ...
        while (rs.next()) {
            ...
            ed.setSub1(rs.getString("subject1"));
            ed.setSub2(rs.getString("subject2"));
            ed.setSub3(rs.getString("subject3"));
