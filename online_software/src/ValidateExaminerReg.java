...
public class ValidateExaminerReg extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (res.next())
            {
            	 String mess="already registered";
                 request.setAttribute("mess",mess);
                 
                 RequestDispatcher dispatcher = request.getRequestDispatcher("mess.jsp");
               ...
               String mess1="You Are Successfully Registered";
                
               request.setAttribute("mess1",mess1);
               
               RequestDispatcher dispatcher = request.getRequestDispatcher("mess1.jsp");
               dispatcher.forward( request, response ); 
            }
