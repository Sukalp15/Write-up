...
<div id="wrapper">
  ...
  <form action="Show_questions" method="post">
    ...
    <%
        ...
        out.println("<tr><td>" + pb.getquesid() + "</td>  <br>  <td></td><td>" + pb.getQuestion() + "</td></br> <td></td> <td><br>" + pb.getOp1() + "</td> <td></td> </br><td>" + pb.getOp2()+ "</td> <td></td> <td>" + pb.getOp3()+ "</td> <td></td> <td>" + pb.getOp4() + "</td> <td></td><td></td> <td>" + pb.getMarks()+"</td> <td></td> <td>" + pb.getFac_name() );
